...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    %restrictions, performing server-based accessibility analysis in combination
...
%    networks (OpenStreetMap (OSM) or General Transit Feed Specification (GTFS)),
