...
\chapter{Overview and related work}
  ...
  \section{Web applications for accessibility mapping}
    ...
    \begin{figure}[t]
      \subcaptionbox{
        \label{fig:overv:asdf0}
        Patent: Method of Providing Travel Time, 2001
        \cite{ran2001method}.}
      {\includegraphics[width=0.32\textwidth]{./img/overv-patnt.png}}
      \hfill
      \subcaptionbox{
        \label{fig:overv:asdf1}
        Visualization of Quality of Mobility in Public Transport, 2010
        \cite{Glander2010}.}
      {\includegraphics[width=0.32\textwidth]{./img/overv-berln.png}}
      \hfill
      \subcaptionbox{
        \label{fig:overv:asdf2}
        Network-Based Accessibility Visualization in Potsdam, 2012
        \cite{hollburghier,Hollburg2014}.}
      {\includegraphics[width=0.32\textwidth]{./img/overv-potsd.png}}
      \caption{Shoo bar.}
    ...
    \begin{figure}[t]
      \subcaptionbox{
        \label{fig:overv:asdf3}
        Patent: Method of Providing Travel Time, 2001
        \cite{ran2001method}.}
      {\includegraphics[width=0.32\textwidth]{./img/overv-patnt.png}}
      \hfill
      \subcaptionbox{
        \label{fig:overv:asdf4}
        Visualization of Quality of Mobility in Public Transport, 2010
        \cite{Glander2010}.}
      {\includegraphics[width=0.32\textwidth]{./img/overv-berln.png}}
      \hfill
      \subcaptionbox{
        \label{fig:overv:asdf5}
        Network-Based Accessibility Visualization in Potsdam, 2012
        \cite{hollburghier,Hollburg2014}.}
      {\includegraphics[width=0.32\textwidth]{./img/overv-potsd.png}}
      \caption{Shoo bar.}
    ...
    \begin{figure}[t]
      \subcaptionbox{
        \label{fig:overv:asdf6}
        Patent: Method of Providing Travel Time, 2001
        \cite{ran2001method}.}
      {\includegraphics[width=0.32\textwidth]{./img/overv-patnt.png}}
      \hfill
      \subcaptionbox{
        \label{fig:overv:asdf7}
        Visualization of Quality of Mobility in Public Transport, 2010
        \cite{Glander2010}.}
      {\includegraphics[width=0.32\textwidth]{./img/overv-berln.png}}
      \hfill
      \subcaptionbox{
        \label{fig:overv:asdf8}
        Network-Based Accessibility Visualization in Potsdam, 2012
        \cite{hollburghier,Hollburg2014}.}
      {\includegraphics[width=0.32\textwidth]{./img/overv-potsd.png}}
      \caption{Shoo bar.}
